...
export const getSystemTheme = () => window.matchMedia("(prefers-color-scheme: dark)").matches ? THEMES.dark : THEMES.light;

export const $currentTheme = atom<typeof THEMES.dark | typeof THEMES.light | "">("")
