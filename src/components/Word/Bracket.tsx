...
export default function Bracket({ color, width, rotate }: { color: string, width: number, rotate: boolean }) {
	return (
		<svg
			...
			<path d="m92 9.9717c8.2256-3.3155 27.643-3.3153 44-3.3153 24.8 0 44.746 0.12844 44.746-5.3555 0-1.0976 3.2542-1.5044 3.2542-0.40678 0 7.4087-26.614 7.4087-48 7.4087-24.8 0-43.797 0.27835-43.797 5.7623 0 1.0976-0.40678 1.2332-0.40678 0.1356 0-5.484-18.997-5.8979-43.797-5.8979-21.386 0-48 0-48-7.4087 0-1.0976 3.2542-1.2332 3.2542-0.1356 0 5.484 19.946 5.8979 44.746 5.8979 16.357 0 35.774-2e-4 44 3.3153z" stroke-width=".45365" />
		</svg>
	)
}